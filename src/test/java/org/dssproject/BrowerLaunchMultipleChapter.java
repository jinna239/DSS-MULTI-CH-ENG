...
public class BrowerLaunchMultipleChapter extends BaseClass {
	...
	public static void main(String[] args) throws AWTException, InterruptedException, IOException {
		...
		driver.findElement(By.xpath("(//i[@class='fa'])[2]")).click();//------fwd
		driver.findElement(By.xpath("(//div[contains(text(),'QUIZ')])[2]")).click();//-----quiz
		
		String CS = driver.findElement(By.id("currentScreen")).getText();
		int currentScreen = Integer.parseInt(CS);
