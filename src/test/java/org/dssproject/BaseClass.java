...
public class BaseClass {
	...
	public static void ScrollDownjs(WebElement downPoint) {
		JavascriptExecutor js=(JavascriptExecutor) driver;
		js.executeScript("arguments[0].scrollIntoView(true)",downPoint);

	}
	
	public static void ScrollUpjs(WebElement upPoint) {
		JavascriptExecutor js=(JavascriptExecutor) driver;
		js.executeScript("arguments[0].scrollIntoView(false)",upPoint);
